...
export class CitiesService {
  ...
  cities: City[] = [
    ...
    { nom: 'Blida البليدة', latitude: 36.471592, longitude: 2.825939, order: 1, totalCas: 40, totalMorts: 4, totalGueris: 12 },
    ...
    { nom: 'Skikda سكيكدة', latitude: 36.881845, longitude: 6.905612, order: 6, totalCas: 2, totalMorts: 1, totalGueris: 0 },
