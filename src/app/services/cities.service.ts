...
export class CitiesService {
  ...
  cities: City[] = [
    { nom: 'Blida البليدة', latitude: 36.471592, longitude: 2.825939, order: 1, totalCas: 47, totalMorts: 7, totalGueris: 30 },
    { nom: 'Alger الجزائر', latitude: 36.772183, longitude: 3.060068, order: 7, totalCas: 12, totalMorts: 0, totalGueris: 0 },
    { nom: 'Tizi Ouzou تيزي وزو', latitude: 36.713468, longitude: 4.047377, order: 4, totalCas: 6, totalMorts: 0, totalGueris: 0 },
    { nom: 'Skikda سكيكدة', latitude: 36.881845, longitude: 6.905612, order: 6, totalCas: 5, totalMorts: 0, totalGueris: 0 },
   ...
   // { nom: 'Guelma قالمة', latitude: 36.462044, longitude: 7.431173, order: 8, totalCas: 2, totalMorts: 0, totalGueris: 0 },
    ...
    { nom: 'Médéa المدية', latitude: 36.262699, longitude: 2.755173, order: 13, totalCas: 1, totalMorts: 1, totalGueris: 0 },
